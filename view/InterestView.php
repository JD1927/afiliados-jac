...
if ($_POST["update"] == "update") {
  try {
    ...
    header('Location: InterestView.php');
  } catch (Exception $exp) {
    echo "ERROR ....R " . $exp->getMessage() . "\n";
  }
}
...
<body>
  <header>
    <div class='navbar-fixed'>
      <nav class='navbar white'>
        <div class='nav-wrapper'><a href='index.html' class='brand-logo grey-text text-darken-4'>Ocupación</a>
  ...
  if($_POST['edit'] !== 'edit'){
  echo "<div class='row'>
          <form id='interest' name='create' action='InterestView.php' method='POST'>
            <div class='row'>
  ...
  if($_POST['edit'] !== 'edit'){
                ...
                for ($i=0; $i < $i_lenght; $i++) { 
                  ...
                  <tr>
                    <form id='interest' name='create' action='InterestView.php' method='POST'>
                      ...
                      <td>". $interest[$i][2] ."</td>
                      <td>
                        <input name='code' value='".$interest[$i][1]."' type='text' hidden>
                        <input name='description' value='".$interest[$i][2]."' type='text' hidden>
    ...
    echo "<div class='row'>
            <form id='interest' action='InterestView.php' method='POST'>
              <div class='row'>
                <div class='input-field col s6 m7'>
                ...
                <div class='input-field col s6 m5'>
                  ...
                  <a href='InterestView.php' class='waves-effect waves-light btn grey'><i class='material-icons right'>cancel</i>Cancelar</a>
                </div>
              </div>
            </form>
          </div>";
