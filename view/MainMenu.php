...
<head>
  ...
  <title>Menu Principal - JAC</title>
    ...
    (function () {
      ...
      trekkie.ready(function () {
        ...
        window.ShopifyAnalytics.lib.page(
          null,
          { "pageType": "page", "resourceType": "page", "resourceId": 18650398809 }
        );
  ...
  <header>
    <div class="navbar-fixed">
      <nav class="navbar white">
        <div class="nav-wrapper"><a href="#!" class="brand-logo grey-text text-darken-4">Menu Principal</a>
          <ul id="nav-mobile" class="right">
            ...
            <li class="hide-on-med-and-down"><a title="Cerrar sesión" href="../view/logout.php"><i class="material-icons">rotate_left</i></a>
            </li>
        </div>
      </nav>
    </div>
