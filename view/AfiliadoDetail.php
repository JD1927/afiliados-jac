        ...
        <div class='row'>
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input id='fullname' name='fullname' type='text' value='".$afiliados[$i][4]."' autocomplete='off' readonly>
            ...
            <div class='row'>
              <div class='input-field col s6'>
                <input id='birth_date' name='birth_date' type='date' value='".$afiliados[$i][5]."' readonly>
                <label for='birth_date'>Fecha de Nacimiento</label>
              </div>
              <div class='input-field col s6'>
                  <select name='cod_gender' disabled>
            ...
            <div class='row'>
              <div class='input-field col s6'>
                <input id='address' name='address' type='text' value='".$afiliados[$i][7]."' autocomplete='off' readonly>
                <label for='address'>Dirección</label>
              </div>
              <div class='input-field col s6'>
                <input id='email' name='email' type='email' value='".$afiliados[$i][8]."' autocomplete='off' readonly>
            ...
            <div class='row'>
              <div class='input-field col s6'>
                  <select name='cod_health' disabled>
                    <option value='".$afiliados[$i][11]."' selected> ".$afiliados[$i][12]."</option>";
            echo "</select>
                  <label>EPS</label>
              </div>
              <div class='input-field col s6'>
                  <select name='cod_thealth' disabled>
            ...
            <div class='row'>
              <div class='input-field col s6'>
                  <select name='cod_committee' disabled>
                    <option value='".$afiliados[$i][15]."' selected>".$afiliados[$i][16]."</option>";
            echo "</select>
                  <label>Cómité</label>
              </div>
              <div class='input-field col s6'>
                  <select name='cod_knowledge' disabled>
